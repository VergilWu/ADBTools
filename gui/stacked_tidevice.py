...
class TiDevicePage:
    ...
    def init_ui(self):
        ...
        self.btn_install_app_list.setFixedSize(120, 30)
        ...
        self.btn_choose_apk.setFixedSize(80, 20)
        ...
        self.edit_pkg_name.setFixedSize(250, 25)
        self.edit_pkg_name.setPlaceholderText('com.example.application')
        self.edit_pkg_name.setText('com.example.application')
