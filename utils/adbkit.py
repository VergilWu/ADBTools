...
class AdbKit:
    ...
    def __adb_device(self):
        ...
        # 卸载
        device.uninstall("com.example.application")
        ...
        # 清空APP
        device.app_clear("com.example.application")
        # 杀掉应用
        device.app_stop("com.example.application")
        ...
        print(device.package_info("com.example.application"))  # dict
    ...
    def get_prop(self, prop: str) -> str:
        """获取设备属性"""
        return self.adb_device.prop.get(prop)
